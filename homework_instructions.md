...
exports.twitter = {
  consumer_key: process.env.x8UGHwH9Zmi3P4TvwlQvp3bXl,
  consumer_secret: process.env.QMbYq7XcdAUQnIEbgJdcgN4jjZs3ENeKB4Y5XA7G53cjjjtMBQ,
  access_token_key: process.env.950156176909590528-5D9CO4ztfk46s87BMreX4mJaZAMZLV2,
  access_token_secret: process.env.TA1ZZFOfAQBDWtAlRpO9DLaiJWK9hx13xY6jniI27HU0R
};

exports.spotify = {
  id: process.env.44a477d02589470c8f5a2dabb2e735cf,
  secret: process.env.f79fe7e33e654e7ab9f0f0243be228e3s
};
```
